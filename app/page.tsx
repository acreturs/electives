    ...
    >
      ...
      <footer className="shrink-0 border-t border-card-border bg-card-bg px-5 py-2.5 flex flex-wrap items-center justify-between gap-3 z-10">
        <p className="text-[11px] text-muted-fg max-w-xl leading-relaxed">
          ...
          Always verify with the official <a href="https://campus.tum.de" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-primary transition-colors">TUM course catalogue</a>.
        </p>
        <a
